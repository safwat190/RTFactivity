...
```
![](man/figures/direct indirect scatter.png)
...
## 🌍 Applications
RTFactivity was developed to identify TFs driving beneficial cell state transitions such as in:
...
## 📚 Citation
Ahmed S. Abouhashem, et al. (2025). Identification of Skin Multicellular Reprogramming Factors as Potential Treatment for Non-Healing Diabetic Foot Ulcers. [Under Revision]
RTFactivity GitHub: https://github.com/safwat190/RTFactivity  

**If you use scoring function "calculate_relative_score" which is the same as "fgsea" from the package fgsea, please cite the package original papers: **
